...
public class ContextUtility implements java.io.Serializable {
	...
	private static void updateVariable(ProcessContext context, 
    	...
    	switch (key) {
			case "indiepubReleaseOrderUrl":
				setProcessVariable(context, "indiepubReleaseOrderUrl", value);
			break;
			case "cronIndiepubReleaseOrder":
			    boolean run = "Y".equalsIgnoreCase(value); 
				setProcessVariable(context, "cronIndiepubReleaseOrder", run);
			break;
		}
